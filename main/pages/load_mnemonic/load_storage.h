 ...
 * Load Storage Page
 *
 * Lists stored mnemonics from flash or SD card.
 * Select -> decrypt -> key confirmation -> home.
 * Inline delete via trash icon on each entry.
 */

#ifndef LOAD_STORAGE_H
#define LOAD_STORAGE_H
 ...
 * @param success_cb Callback on successful key load
